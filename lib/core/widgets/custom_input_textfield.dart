...
class CustomInputTextField extends StatefulWidget {
  const CustomInputTextField({
    ...
    this.borderRestriction = true,this.borderColor = AppColors.white, required this.labelText,
    this.onChange,
  });
...
class CustomInputTextFieldState extends State<CustomInputTextField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      keyboardType: widget.numberKeyboard ? TextInputType.number : TextInputType.text,
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.symmetric(vertical: widget.maxLines>=2?6: 2, horizontal: 18),
        ...
        hintStyle: GoogleFonts.poppins(
            fontSize: 14, fontWeight: FontWeight.w400, color: AppColors.whitish),
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: widget.isFilled && widget.borderRestriction
              ? BorderSide.none
              :  BorderSide(
              color: widget.borderColor, width: 0.6),
        ),
