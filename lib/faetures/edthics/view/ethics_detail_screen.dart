...
class EthicDetailScreen extends StatelessWidget {
  final EthicsController controller = Get.find();
  final AppSizes appSizes = AppSizes();

  EthicDetailScreen({super.key});
      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          body: Container(
            ...
            child: Obx(() {
              final currentFruit =
                  controller.ethics[controller.currentIndex.value];
              return Column(
